<%@ Page Title="" Language="C#" MasterPageFile="~/SignMasterPage.master" AutoEventWireup="true" CodeFile="bed.aspx.cs" Inherits="bed" %>
...
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Mobile No:+91 9327443181</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Catagory:-Semi special</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Today Book:-22/3/22</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Booking Bed:-25/3/22</p>
...
<div class="thumb-lg member-thumb mx-auto"><img src="https://bootdey.com/img/Content/avatar/avatar2.png" class="rounded-circle img-thumbnail" alt="profile-image"></div>
<div class="">
<h4>Name:-Joshi Het</h4>
</div>
<div class="mt-4">
<div class="row">
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Mobile No:+91 82004 45896</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Catagory:-General</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Today Book:-23/3/22</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Booking Bed:-26/3/22</p>
    <p class="mb-0 text-muted">
...
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Catagory:-ICU</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Today Book:-24/3/22</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Booking Bed:-27/3/22</p>
    <p class="mb-0 text-muted">
