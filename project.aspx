<%@ Page Title="" Language="C#" MasterPageFile="~/SignMasterPage.master" AutoEventWireup="true" CodeFile="project.aspx.cs" Inherits="project" %>
    ...
    <div class="row">
        <div class="col-lg-4" >
            <aside class="user-info-wrapper" >
                <div class="user-cover" style="background-image: url(https://2.bp.blogspot.com/-MEc_36aABIk/WvqE5IdOF5I/AAAAAAAAAJQ/_2WOirvws2IXfWjRxlzJhoyrBjRp4VTrQCLcBGAs/s1600/VADODARA.jpg);">
                    >
                </div>
                <div class="user-info">
                    ...
                    <div class="user-data">
                        <h4>Vadodara</h4><span></span>
                    </div>
                </div>
            </aside>
            <nav class="list-group">
                <a class="list-group-item" href="#"><i class="fa fa-user "></i>BOOK A BED IN HOSPITAL </a>  
                <a class="list-group-item" href="#"><i class="fa fa-user"></i>MEDICINE</a>
                <a class="list-group-item" href="#"><i class="fa fa-map"></i>BLOOD BANK</a>
                <a class="list-group-item" href="#"><i class="fa fa-user"></i>LABORATORY</a>
                <a class="list-group-item" href="#"><i class="fa fa-user"></i>AMBULANCE</a>
                <a class="list-group-item" href="#"><i class="fa fa-user"></i>DOCTOR APPOINTMENT</a>
