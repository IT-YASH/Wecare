<%@ Page Title="" Language="C#" MasterPageFile="~/SignMasterPage.master" AutoEventWireup="true" CodeFile="Doctorlogin.aspx.cs" Inherits="LoginPage" %>
    ...
    <div class="container" style="padding-top: 70px; margin-bottom: 90px; height: 380px; width: 400px;">
        <div class="center-page">
            ...
            <div class="col-xs-11" style="margin-top: 10px;">
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<asp:Button ID="Button1" runat="server" class="btn btn-danger" Text="DON'T HAVE AN ACCOUNT? " Width="303px" CssClass="col-xs-offset-0" BackColor="red" BorderColor="Black" BorderStyle="None" ForeColor="White" Height="40px" PostBackUrl="SignUpAsDoctor.aspx" OnClick="Button1_Click"  />
            </div>
