<%@ Page Title="" Language="C#" MasterPageFile="~/SignMasterPage.master" AutoEventWireup="true" CodeFile="Bloodbank.aspx.cs" Inherits="Bloodbank" %>
...
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Blood Type:A+</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Address:-526-sharadnagar,Tarsali</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Morning Time:8AM to 1PM</p>
...
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Blood Type:B-</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Address:-26,kesar 36 kapurai</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Afternoon Time:4PM to 7PM</p>
    <p class="mb-0 text-muted">
...
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Blood Type:O+</p>
</div>
</div>
<div class="col-4">
<div class="mt-3">
...
<div class="col-4">
<div class="mt-3">
<p class="mb-0 text-muted">Night Time:7PM to 9PM</p>
    <p class="mb-0 text-muted">
